...
- **Session JWT**: an Ed25519-signed token obtained by logging in with a password. It backs the admin console and authorizes `/v1/playlist.m3u` while playback authentication is enabled.
