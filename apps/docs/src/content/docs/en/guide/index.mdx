...
<CardGrid>
  ...
  <Card title="Variants & tracks" icon="ph:package" href="/en/guide/variants/">
    Capability boundaries per distribution variant, plus precise video, audio, and subtitle selection.
  </Card>
