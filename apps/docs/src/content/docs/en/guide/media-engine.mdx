...
- If a fallback is needed but no ffmpeg is available in the runtime, the request fails with `503`. The Lite and Core images ship without ffmpeg — see [Lite, Core & Full](/en/guide/variants/).
