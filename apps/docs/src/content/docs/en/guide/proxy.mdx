...
<CardGrid>
  <Card title="Direct by default, proxy a few hosts" icon="ph:arrow-right">
  ...
  <Card title="Proxy by default, a few direct">
  ...
  <Card title="ffmpeg in a container, proxy on the host">
