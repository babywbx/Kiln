...
<CardGrid>
  <Card title="Create your first channel" icon="ph:arrow-right">
    Write a minimal config and get it serving: [First channel](/en/start/first-channel/).
  </Card>
  <Card title="Containers">
    Prefer containers? The three image boundaries are covered in [Docker](/en/start/docker/).
  </Card>
  <Card title="It will not install">
    Network, permission, and architecture failures are covered in [Troubleshooting](/en/guide/troubleshooting/).
  </Card>
</CardGrid>
