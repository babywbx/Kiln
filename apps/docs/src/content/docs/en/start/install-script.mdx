...
Re-running the script is the upgrade path. Comparison covers the SemVer core and prerelease identifiers, so `1.1.1-rc.1` correctly sorts before `1.1.1`.

```bash
curl -fsSL https://raw.githubusercontent.com/babywbx/Kiln/main/install.sh | sh -s -- --version 1.1.1
```
