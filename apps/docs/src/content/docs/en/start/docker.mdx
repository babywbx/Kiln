...
| Tag shape | Meaning |
| --- | --- |
| `:1.1.1-lite`, `:1.1-lite`, `:1-lite`, `:lite` | Exact, minor, major, and newest release of the lite variant |
| `:1.1.1-core`, `:1.1-core`, `:1-core`, `:core` | The same set for core |
| `:1.1.1`, `:1.1`, `:1`, `:latest` | The same set for full, with `:latest` as its newest release |
