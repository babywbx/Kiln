...
<CardGrid>
  <Card title="Authentication" icon="ph:key">
    The full credential model and operational guidance in [Authentication](/en/guide/auth/).
  </Card>
  <Card title="Configuration" icon="ph:sliders">
    Values for the `auth`, `security`, and `egress` sections in [Configuration](/en/reference/config/).
  </Card>
  <Card title="Command line" icon="ph:terminal">
    Binary flags and helper scripts in [Command line](/en/reference/cli/).
  </Card>
</CardGrid>
