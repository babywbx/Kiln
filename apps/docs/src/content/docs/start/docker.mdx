...
| 标签格式 | 含义 |
| --- | --- |
| `:1.1.0-lite`、`:1.1-lite`、`:1-lite`、`:lite` | lite 变体的精确版本、次版本、主版本与最新版 |
| `:1.1.0-core`、`:1.1-core`、`:1-core`、`:core` | core 变体的同一组标签 |
| `:1.1.0`、`:1.1`、`:1`、`:latest` | full 变体的同一组标签，`:latest` 即 full 的最新版 |
